...
<body>
<div class="pd-20">
  <form action="/addPesticide.do" method="post" class="form form-horizontal" id="form-pesticide-add">
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>名称：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="pestName" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>生产企业：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text" name="pestProd" required>
      </div>
    </div>
    <div class="row cl">
    <label class="form-label col-2"><span class="c-red">*</span>功效：</label>
    <div class="formControls col-10">
         <input type="text" class="input-text"  name="pestEffect" required>
    </div>
  </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>配料：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="pestElement" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>生产日期：</label>
      <div class="formControls col-10">
        <input  type="text" class="input-text" onclick="WdatePicker()" id="produceTime" name="pestProdDate" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>有效期：</label>
      <div class="formControls col-10">
        <input  type="text" class="input-text"  onclick="WdatePicker()" onchange="compProLimDat()" id="limitDate"  name="pestLimitDate" required>
      </div>
    </div>
    <div class="row cl">
