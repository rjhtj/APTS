...
<body>
<div class="pd-20">
  <form action="/updatePesticide.do/${pesticide.pestId}" method="post" class="form form-horizontal" id="form-pesticide-update">
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>名称：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="pestName" value="${pesticide.pestName}" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>生产企业：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text" name="pestProd" value="${pesticide.pestProd}" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>功效：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="pestEffect" value="${pesticide.pestEffect}" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>配料：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="pestElement" value="${pesticide.pestElement}" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>生产日期：</label>
      <div class="formControls col-10">
        <input  type="text" class="input-text" onclick="WdatePicker()" name="pestProdDate" value="${pesticide.pestProdDate}" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>有效期：</label>
      <div class="formControls col-10">
        <input  type="text" class="input-text"  onclick="WdatePicker()"  name="pestLimitDate" value="${pesticide.pestLimitDate}" required>
      </div>
    </div>
    <div class="row cl">
