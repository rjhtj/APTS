...
<body>
<div class="pd-20">
    <form action="/addStorage.do" method="post" class="form form-horizontal" id="form-storage-add">
      <div>
        存储信息
      </div>
      <div class="row cl">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-10">
          <input type="text" class="input-text" onclick="WdatePicker()" name="storeTime" required>
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-2"><span class="c-red">*</span>存储方式：</label>
        <div class="formControls col-10">
          <input type="text" class="input-text"  name="storeMethod" required>
        </div>
      </div>
      <div class="row cl">
...
<script type="text/javascript" src="../resources/js/addstorage.js"></script>
