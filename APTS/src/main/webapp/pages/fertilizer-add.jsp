...
<body>
<div class="pd-20">
  <form action="/addFertilizer.do" method="post" class="form form-horizontal" id="form-fertilizer-add">
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>名称：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="fertName" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>生产企业：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text" name="fertProd" required>
      </div>
    </div>
    <div class="row cl">
    <label class="form-label col-2"><span class="c-red">*</span>功效：</label>
    <div class="formControls col-10">
      <input type="text" class="input-text"  name="fertEffect" required>
    </div>
  </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>配料：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="fertElement" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>生产日期：</label>
      <div class="formControls col-10">
        <input  type="text" class="input-text" onclick="WdatePicker()" id="produceTime" name="fertProdDate" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>有效期：</label>
      <div class="formControls col-10">
        <input  type="text" class="input-text"  onclick="WdatePicker()" onchange="compProLimDat()" id="limitDate" name="fertLimitDate" required>
      </div>
    </div>
    <div class="row cl">
