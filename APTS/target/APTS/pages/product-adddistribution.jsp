...
<body>
<div class="pd-20">
    <form action="/addDistribution.do" method="post" class="form form-horizontal" id="form-distribution-add">
      <div>
        销售信息
      </div>
      <div class="row cl">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-10">
          <input type="text" class="input-text"  name="customer" required>
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-2"><span class="c-red">*</span>销售时间：</label>
        <div class="formControls col-10">
          <input type="text" class="input-text"  onclick="WdatePicker()" name="distributionTime" required>
        </div>
      </div>
      <div class="row cl">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-10">
          <input type="text" class="input-text"  name="distributionMethod" required>
        </div>
      </div>
...
<script type="text/javascript" src="../resources/js/adddistribution.js"></script>
