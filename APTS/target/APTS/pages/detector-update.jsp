...
<body>
<div class="pd-20">
  <form action="/updateDetector.do" method="post" class="form form-horizontal" id="form-detector-update">
    <input type="hidden" name="detectorId" value="${detector.detectorId}">
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>名称：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text"  name="name" value="${detector.name}" required>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>地址：</label>
      <div class="formControls col-10">
        <input type="text" class="input-text" name="address" value="${detector.address}" required>
      </div>
    </div>
    <div class="row cl">
